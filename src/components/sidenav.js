            ...
            <div className={`container overflow-auto bg-background py-10 px-5 h-full max-h-screen`}>
                <article>
                    <p>
                        ...
                        it uses
                        <a className="text-primary font-semibold" target="_blank" href="https://handlebarsjs.com/guide/#what-is-handlebars">Handlebars templating</a>
                        which allows more advanced features, like loops and conditional statements.
                    </p>
                    <Divider />
                    <p>
                    ...
                    <Divider />
                    <p>On top of the regular Handlebars syntax, there are a number of additional helpers available:</p>
                    ...
                    <p>You can use these helpers in conditional statements like:</p>
